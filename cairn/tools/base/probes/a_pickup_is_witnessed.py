...
``cairn/tools/base`` because that is WHAT IT WATCHES: the pickup door lives in
``cairn/tools/base/transitions.py``, and the one way this design fails silently is the door
...
# sharper still, because the voyage that BUILT this door also sails through it: cairn/tools/base's
