...
proofs run when it lands):
    python3 cairn/tools/base/proofs/test_core_values.py     # bare: exit 0 = green
    pytest cairn/tools/base/proofs/test_core_values.py       # discovered as test_* functions
...
# Run bare (`python3 cairn/tools/base/proofs/test_core_values.py`) without an editable
...
from cairn.tools.base.core_values import CORE_VALUES, CoreValue, CoreValuesMixin
...
_COMMONS_RECORD = _REPO_ROOT.parent / "CairnCommons" / "intentions-not-beside-code" / "core-values.md"
