...
the Unix socket is a file (db_domain's documented asymmetry).
    ...
    python3 cairn/chart/proofs/test_chart_tree.py     # exit 0 = green
"""
...
from cairn.chart import dial as dial_mod
from cairn.chart import tree
from cairn.chart.dial import dial
from cairn.chart.orient import STRATA, OrientRefused
from cairn.chart.tree import (
...
def test_the_librarians_tools_are_the_only_door():
    allowed = {
        ...
        # cairn.chart.triage the same day again (chart-triage), then
        # cairn.chart.hypothesize and cairn.chart.validate (chart-hypothesize,
        ...
        dial_mod.__file__: ("__future__", "json", "os", "re", "sys",
                            ...
                            "cairn.chart.hypothesize", "cairn.chart.orient",
                            "cairn.chart.survey", "cairn.chart.triage",
                            "cairn.chart.validate"),
    }
...
def test_tree_is_a_legal_stratum_at_the_packet_gate():
    from cairn.chart.orient import validate_orient
