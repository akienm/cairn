"""codemother/digest.py — nighttime batch consolidation on Hex.
...
from cairn.devices.codemother.types import PatternType, TypePolarity, PatternSignal, negative
from cairn.devices.codemother.project import load_types, save_type, ensure_project
