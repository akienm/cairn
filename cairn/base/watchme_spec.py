...
``cairn.chart.orient.ticket_claim_error``, and it never opens the ticket — it asks whether a
...
4 says that makes it a tracked debt, not a resting state.
    ...
    python3 cairn/base/proofs/test_watchme_spec.py          # exit 0 = green
    python3 -m cairn.base.watchme_spec                      # sweep every filed ticket
"""
...
# (cairn/base/probe.py) on purpose: know the primitive, know the spec — nobody should have to
