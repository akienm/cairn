"""codemonkey/constraints_compiler.py — compile the negative body into the constraints lab.
...
from cairn.devices.codemonkey.project import load_types, save_constraint, ensure_project
