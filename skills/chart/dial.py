...
is a finding, not noise).
    ...
    python3 -m skills.chart.dial            # the live berth
    python3 -m skills.chart.dial <dir>      # any berth
"""
...
import cairn.machines.constrain.constrain as _constrain
import cairn.machines.decompose.decompose as _decompose
import cairn.machines.hypothesize.hypothesize as _hypothesize
import cairn.machines.survey.survey as _survey
import cairn.machines.triage.triage as _triage
import cairn.machines.validate.validate as _validate
from cairn.tools.chain.grammar import (INSTANCE_DIR, STRATA)
from cairn.machines.orient.orient import (AUTHORED_FIELDS)
