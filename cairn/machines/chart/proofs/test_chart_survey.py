...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/machines/chart/proofs/test_chart_survey.py     # exit 0 = green
"""
...
from cairn.machines.chart import survey as survey_mod
from cairn.machines.chart.survey import (
...
def test_the_door_composes_the_installed_judges(root, orient_berth, constrain_berth):
    ...
    assert "cairn.machines.chart.survey" not in inspector_src, \
...
def test_import_allowlist(root, orient_berth, constrain_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "pathlib", "time",
             ...
             "cairn.machines.chart.tree", "cairn.tools.orient.orient")
