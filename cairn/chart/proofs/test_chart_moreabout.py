"""Proof for chart/moreabout.py — the learning door. Teeth a hollow build could not pass:
  ...
  - A WALK, NEVER A RE-RUN, BY IMPORT PHYSICS: AST allowlist on moreabout.py — its only
    cairn door is cairn.chart.tree; cairn.chart.orient (the floor/gate machinery),
...
Unix socket is a file (db_domain's documented asymmetry).
    ...
    python3 cairn/chart/proofs/test_chart_moreabout.py     # exit 0 = green
"""
...
from cairn.chart import moreabout as moreabout_mod
from cairn.chart.moreabout import MoreaboutRefused, expand, signal
from cairn.chart.tree import deposit_learning, nexus_table
...
def test_a_walk_never_a_rerun_import_physics():
    ...
    for forbidden in ("cairn.chart.orient", "cairn.librarian", "cairn.db_domain",
                      "subprocess"):
