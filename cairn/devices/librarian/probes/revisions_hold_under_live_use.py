...
``cairn/devices/librarian`` because that is WHAT IT WATCHES: the fifth tenure behaviour —
...
tree (``cairn/devices/librarian/shim.py``, ``tree: str = "library"``), so a probe pointed at
