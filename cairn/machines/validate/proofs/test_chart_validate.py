...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/machines/validate/proofs/test_chart_validate.py     # exit 0 = green
"""
...
import cairn.machines.hypothesize.hypothesize as hypothesize_mod
from cairn.machines.validate import validate as validate_mod
from cairn.machines.validate.validate import (
...
def test_the_door_composes_the_installed_judges(root, triage_berth,
    ...
    assert "cairn.machines.validate.validate" not in inspector_src, \
...
def test_import_allowlist(root, triage_berth, hypothesize_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "time",
             "cairn.machines.build_inspector.inspector", "cairn.machines.hypothesize.hypothesize",
