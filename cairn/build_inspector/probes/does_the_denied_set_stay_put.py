...
Berthed beside ``cairn/build_inspector`` because that is WHAT IT WATCHES: the fire-path
...
one arrived without the widening: ``cairn.base.nest`` entered the fire path in 047d633
...
_CLOSURE_AT_PROVED = (
    "cairn", "cairn.base", "cairn.base.address", "cairn.base.diagnostic",
    "cairn.base.nest", "cairn.chart.orient", "cairn.chart.verdict", "cairn.charter",
    "cairn.charter.projector", "cairn.import_sieve", "cairn.import_sieve.sieve",
    "cairn.learning_block", "cairn.learning_block.learning_block", "cairn.orient",
    "cairn.orient.orient", "cairn.skill_block", "cairn.skill_block.skill_block",
)
_DENIED_AT_PROVED = (
    "aiohttp", "cairn.chart.tree", "cairn.db_domain", "cairn.inference_domain",
    "cairn.librarian", "ftplib", "http.client", "httpx", "requests", "socket",
...
def survey_the_corpus() -> dict:
    ...
    exists to end.
    """
    from cairn.build_inspector.inspector import _FIRE_PATH, _REPO_ROOT
...
# Same placeholder horizon, same tracked debt, as the probes at cairn/base and
# cairn/inference_domain: the beat rate is not yet a real number.
_HORIZON = 1000
