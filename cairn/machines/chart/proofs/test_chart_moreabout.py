"""Proof for chart/moreabout.py — the learning door. Teeth a hollow build could not pass:
  ...
  - A WALK, NEVER A RE-RUN, BY IMPORT PHYSICS: AST allowlist on moreabout.py — its only
    cairn door is cairn.machines.chart.tree; cairn.machines.chart.orient (the floor/gate machinery),
...
Unix socket is a file (db_domain's documented asymmetry).
    ...
    python3 cairn/machines/chart/proofs/test_chart_moreabout.py     # exit 0 = green
"""
...
from cairn.machines.chart import moreabout as moreabout_mod
from cairn.machines.chart.moreabout import MoreaboutRefused, expand, signal
from cairn.machines.chart.tree import deposit_learning, nexus_table
...
def test_a_walk_never_a_rerun_import_physics():
    ...
    allow = ("__future__", "json", "os", "cairn.machines.chart.tree")
    ...
    for forbidden in ("cairn.machines.chart.orient", "cairn.devices.librarian", "cairn.devices.db_domain",
                      "subprocess"):
