...
one) instead of the gate.
    ...
    python3 cairn/devices/codemonkey/machines/survey/proofs/test_deposit_survives_a_move.py
"""
...
MOVES_FROM = "cairn/devices/codemonkey/machines/survey/survey.py"
...
def base_packet():
    ...
    return {
        ...
        "absences": [{"what": "a deposit-time tolerance anywhere in the six stages",
                      "measure": "grep over cairn/devices/codemonkey/machines/ "
