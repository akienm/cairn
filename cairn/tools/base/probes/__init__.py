...
watch ``cairn/tools/base``, so they live here, beside it. Each module declares module-level
``PROBE`` — a frozen ``cairn.tools.base.probe.Probe``. The emission gate reads that declaration
