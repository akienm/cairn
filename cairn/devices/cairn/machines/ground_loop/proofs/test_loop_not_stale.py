...
WHAT A HOLLOW BUILD PASSES AND THESE TEETH MUST NOT (Law 8):
  ...
  * Firing on a device that is genuinely broken. The probe fires on a RELATION, and a
    ...
    python3 cairn/devices/cairn/machines/ground_loop/proofs/test_loop_not_stale.py    # exit 0 = green
"""
...
from cairn.devices.cairn.machines.ground_loop.loop import SELF_TROUBLE, TROUBLE_PREFIX  # noqa: E402
from cairn.devices.cairn.machines.ground_loop.probes import loop_not_stale as P  # noqa: E402
