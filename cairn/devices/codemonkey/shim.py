"""codemonkey/shim.py — CodeMonkey's presence on the heartbeat.

CodeMonkey is its own PID, shim-launched on demand via MCP/chat/CLI/skill.
The shim gives CodeMonkey a rack address so the bus can deliver messages to it
