...
corpus is the probe's own __main__ smoke-fire, a deliberate act.
    ...
    python3 cairn/devices/inference_domain/proofs/test_watch_domain_probe.py     # exit 0 = green, no DB
"""
...
from cairn.devices.inference_domain.probes import does_a_domain_ride_the_request as watch
