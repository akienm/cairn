...
``dial`` (which pulls the whole chain) and is the only heavy thing here.
    ...
    python3 cairn/machines/chart/proofs/test_chart_notes.py     # exit 0 = green
"""
...
from cairn.machines.chart import chain
from cairn.machines.chart.chain import ChartNoteRefused
...
def test_the_dial_registry_and_the_chain_are_the_same_seven_in_the_same_order():
    ...
    from cairn.machines.chart import dial
