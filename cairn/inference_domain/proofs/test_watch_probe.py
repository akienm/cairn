...
below is a fixture; the live corpus is the probe's own __main__ smoke-fire, a deliberate act.
    ...
    python3 cairn/inference_domain/proofs/test_watch_probe.py     # exit 0 = green, no DB
"""
...
from cairn.inference_domain.probes import does_the_route_leave_loopback as watch
