...
deposit-back — the whole embed cost of the stratum, readable in the yield report.
    ...
    python3 -m cairn.machines.chart.live counsel "<request>" [nexus] [owner]  # the walk, live
    python3 -m cairn.machines.chart.live learn <berth-path> [nexus]           # deposit-back one packet
    python3 -m cairn.machines.chart.live moreabout "<ask>" [nexus] [owner]    # the learning door
...
from cairn.machines.chart.constrain import constrain_node_content, deposit_constrain
from cairn.machines.chart.dial import dial
from cairn.machines.chart.moreabout import expand, signal
from cairn.machines.chart.orient import CAIRN_ROOT
from cairn.machines.chart.decompose import decompose_node_content, deposit_decompose
from cairn.machines.chart.hypothesize import deposit_hypothesize, hypothesize_node_content
from cairn.machines.chart.survey import deposit_survey, survey_node_content
from cairn.machines.chart.tree import counsel, deposit_learning, deposit_packet
from cairn.machines.chart.triage import deposit_triage, triage_node_content
from cairn.machines.chart.validate import deposit_validate, validate_node_content
from cairn.machines.chart.verdict import (VerdictRefused, mark_deposited, pending,
...
def _chain(argv: list[str]) -> int:
    ...
    if not argv:
        print("usage: python3 -m cairn.machines.chart.live chain <ticket>", file=sys.stderr)
        return 1
    from cairn.machines.chart.verdict import chain_for_ticket
