...
until 2026-07-30 it was written into ``stage_needs``, the field ``cairn/base/needs.py`` owns.
...
proven module and is a change with a ticket, not a drive-by.
    ...
    python3 -m cairn.chart.chain            # scan the live tickets, report ALL nonconformance
"""
