...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/devices/builder/machines/decompose/proofs/test_chart_decompose.py     # exit 0 = green
"""
...
import cairn.devices.builder.machines.survey.survey as survey_mod
from cairn.devices.builder.machines.decompose import decompose as decompose_mod
from cairn.devices.builder.machines.decompose.decompose import (
...
def test_import_allowlist(root, orient_berth, constrain_berth, survey_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "time",
             ...
             "cairn.devices.builder.machines.survey.survey", "cairn.tools.tree.tree",
