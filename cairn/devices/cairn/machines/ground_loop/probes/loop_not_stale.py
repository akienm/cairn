...
device`` carries. Berthed beside ``cairn/devices/cairn/machines/ground_loop`` because that is WHAT IT
...
def _bench_tickets_exist() -> bool:
    ...
    """
    from cairn.devices.cairn.machines.ground_loop.loop import TROUBLE_PREFIX
...
def survey_the_bench() -> dict:
    ...
    from cairn.devices.cairn.machines.ground_loop.loop import SELF_TROUBLE, TROUBLE_PREFIX
