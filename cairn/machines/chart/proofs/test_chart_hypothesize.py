...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/machines/chart/proofs/test_chart_hypothesize.py     # exit 0 = green
"""
...
import cairn.machines.chart.triage as triage_mod
from cairn.machines.chart import hypothesize as hypothesize_mod
from cairn.machines.chart.hypothesize import (
...
def test_the_door_composes_the_installed_judges(root, decompose_berth,
    ...
    assert "cairn.machines.chart.hypothesize" not in inspector_src, \
...
def test_import_allowlist(root, decompose_berth, triage_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "time",
             ...
             "cairn.machines.chart.tree", "cairn.machines.chart.triage")
