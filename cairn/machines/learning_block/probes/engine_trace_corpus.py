...
Berthed HERE, beside ``cairn/machines/learning_block/``, because that component OWNS the trace
store this probe reads — the subject is the corpus the engine writes, and a probe berths
with what it watches, never with the ticket it was compiled from (``cairn/tools/base/probe.py``).
