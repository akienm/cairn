...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/devices/codemonkey/machines/decompose/proofs/test_chart_decompose.py     # exit 0 = green
"""
...
import cairn.devices.codemonkey.machines.survey.survey as survey_mod
from cairn.devices.codemonkey.machines.decompose import decompose as decompose_mod
from cairn.devices.codemonkey.machines.decompose.decompose import (
...
def test_the_door_composes_the_installed_judges(root, orient_berth,
    ...
    assert "cairn.devices.codemonkey.machines.decompose.decompose" not in inspector_src, \
...
def test_every_piece_names_where_it_writes(root, orient_berth, constrain_berth,
    ...
    """
    from cairn.devices.codemonkey.machines.decompose.decompose import inspect_decompose
...
def test_import_allowlist(root, orient_berth, constrain_berth, survey_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "time",
             ...
             "cairn.devices.codemonkey.machines.survey.survey", "cairn.tools.tree.tree",
