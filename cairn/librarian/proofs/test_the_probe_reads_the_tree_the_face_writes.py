...
the TREE never is, because it is the thing under test.
    ...
    python3 cairn/librarian/proofs/test_the_probe_reads_the_tree_the_face_writes.py
    # exit 0 = green
"""
...
from cairn.librarian.probes import standing_moves_under_live_use as probe
from cairn.librarian.shim import LibrarianShim
from cairn.librarian.trees import OWNER, corroborate, deposit, node_id_for
