...
gets a temp home.
    ...
    python3 cairn/devices/ground_loop/proofs/test_pulse_service.py     # exit 0 = green
"""
...
from cairn.devices.ground_loop.discovery import (  # noqa: E402
...
def test_the_watchme_probe_is_armed_and_judges_from_fixtures():
    ...
    from cairn.devices.ground_loop.probes import pulse_service_within_a_beat as psw
