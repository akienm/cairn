...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/devices/builder/machines/survey/proofs/test_chart_survey.py     # exit 0 = green
"""
...
from cairn.devices.builder.machines.survey import survey as survey_mod
...
def test_the_door_composes_the_installed_judges(root, orient_berth, constrain_berth):
    ...
    assert "cairn.devices.builder.machines.survey.survey" not in inspector_src, \
