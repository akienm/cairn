...
process, so its green proved nothing at all.
    ...
    python3 cairn/devices/cairn/machines/ground_loop/proofs/test_staleness.py     # exit 0 = green
"""
...
def test_the_predicate_names_no_symbol_and_reads_no_clock():
    ...
    import inspect
    import textwrap
    from cairn.devices.cairn.machines.ground_loop import staleness as st
...
def test_the_real_outage_is_caught_by_this_predicate():
    ...
    frame.__file__ = str(Path(__file__).resolve().parents[5] / "cairn" / "base" / "probe.py")
