...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/devices/codemonkey/machines/hypothesize/proofs/test_chart_hypothesize.py     # exit 0 = green
"""
...
import cairn.devices.codemonkey.machines.triage.triage as triage_mod
from cairn.devices.codemonkey.machines.hypothesize import hypothesize as hypothesize_mod
from cairn.devices.codemonkey.machines.hypothesize.hypothesize import (
...
def test_the_door_composes_the_installed_judges(root, decompose_berth,
    ...
    assert "cairn.devices.codemonkey.machines.hypothesize.hypothesize" not in inspector_src, \
...
def test_import_allowlist(root, decompose_berth, triage_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "time",
             ...
             "cairn.tools.tree.tree", "cairn.devices.codemonkey.machines.triage.triage",
