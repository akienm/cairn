...
FILED EDGES (children of this stone, not faked):
  ...
  - (retired 2026-08-09, ticket ground-loop-writes-its-own-liveness) The wall-clock DAEMON
    ...
    cairn.devices.cairn.machines.ground_loop) — still the thin wrapper this file stays provable without.
"""
...
class GroundLoopDevice(BaseDevice):
    ...
    def settings(self) -> dict:
        return {
            ...
            "clock; the wall-clock backing is __main__.py (python3 -m cairn.devices.cairn.machines.ground_loop), the thin "
            ...
            "~/.cairn/devices/cairn/machines/ground_loop/0/liveness.json atomically — last-run, state, pid; the "
