...
beside ``cairn/devices/ground_loop`` because that is WHAT IT WATCHES: the pulse half of
...
WHAT IT READS: the loop's own liveness record (``~/.cairn/devices/ground_loop/0/
