...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/machines/chart/proofs/test_chart_decompose.py     # exit 0 = green
"""
...
import cairn.machines.chart.survey as survey_mod
from cairn.machines.chart import decompose as decompose_mod
from cairn.machines.chart.decompose import (
...
def test_the_door_composes_the_installed_judges(root, orient_berth,
    ...
    assert "cairn.machines.chart.decompose" not in inspector_src, \
...
def test_import_allowlist(root, orient_berth, constrain_berth, survey_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "time",
             ...
             "cairn.machines.chart.survey", "cairn.machines.chart.tree")
