"""Proof: the HOST SEAM (cairn/inference_domain/host.py) meters real tokens or refuses.
...
node's VALIDATION — not smuggled in here, where an absent host would read as a flake.
    ...
    python3 cairn/inference_domain/proofs/test_host.py     # exit 0 = green, no host needed
"""
