...
THE ADDRESS COMES FROM THE ONE OWNER. ``cairn.base.address.instance_path`` — built 2026-08-12
...
class BreadcrumbLog:
    ...
    must not create anything (``cairn.base.address``'s own bound, and Law 6: provisioning is a
