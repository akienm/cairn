"""codemonkey/vocabulary.py — universal pattern vocabulary, project-agnostic.
...
from cairn.devices.codemonkey.types import PatternType, PatternSignal, TypePolarity
