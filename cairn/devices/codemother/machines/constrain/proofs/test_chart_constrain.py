...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/devices/codemother/machines/constrain/proofs/test_chart_constrain.py     # exit 0 = green
"""
...
from cairn.devices.codemother.machines.constrain import constrain as constrain_mod
...
def test_the_door_composes_the_installed_judges(root, orient_berth):
    ...
    assert "cairn.devices.codemother.machines.constrain.constrain" not in inspector_src, \
