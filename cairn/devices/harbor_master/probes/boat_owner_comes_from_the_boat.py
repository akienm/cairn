...
``boat-owner-comes-from-the-boat``). Berthed beside ``cairn/devices/harbor_master`` because that
...
from cairn.devices.harbor_master.clearance import OwnerUnresolvable, boat_owner_of
