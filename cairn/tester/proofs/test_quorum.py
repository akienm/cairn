...
WHAT THIS PROVES:
  ...
  - THE TRAIL APPENDS. A second review is a new dated entry, never a replacement (Law 7).
    ...
    python3 cairn/tester/proofs/test_quorum.py     # exit 0 = green
"""
...
from cairn.tester import quorum
from cairn.tester.device import GREEN, RED, VALIDATION_FIELDS
from cairn.tester.validation_store import (
    read_validations,
