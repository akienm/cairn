...
(nonce table, self-cleaning), as in the trees, loop, and library proofs.
    ...
    python3 cairn/librarian/proofs/test_librarian_summarize.py     # exit 0 = green
"""
...
from cairn.librarian import summarize as summarize_module
from cairn.librarian.summarize import (
...
def test_summarize_opens_no_door_of_its_own():
    allowed = ("__future__", "hashlib", "re", "cairn.librarian.trees")
