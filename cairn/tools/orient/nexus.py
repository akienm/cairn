...
FOUNDING_CORRECTIONS = [
    {
        ...
        "provenance": {"source": "cairn/tools/orient/orient.py call_sites (its Provenance)",
    ...
    },
    {
        ...
        "provenance": {"source": "cairn/tools/orient/orient.py device_census (its Provenance)",
    ...
    },
    {
        "content": "An echo label welded to && attested a push that never happened, and "
                   ...
                   "not narration.",
        "provenance": {"source": "cairn/tools/orient/orient.py repo_truth (its Provenance)",
    ...
    },
    {
        ...
        "provenance": {"source": "cairn/tools/orient/orient.py device_census (sharpened "
