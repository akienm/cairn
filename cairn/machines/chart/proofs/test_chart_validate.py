...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/machines/chart/proofs/test_chart_validate.py     # exit 0 = green
"""
...
import cairn.machines.chart.hypothesize as hypothesize_mod
from cairn.machines.chart import validate as validate_mod
from cairn.machines.chart.validate import (
...
def test_the_door_composes_the_installed_judges(root, triage_berth,
    ...
    assert "cairn.machines.chart.validate" not in inspector_src, \
...
def test_import_allowlist(root, triage_berth, hypothesize_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "time",
             "cairn.machines.build_inspector.inspector", "cairn.machines.chart.hypothesize",
             "cairn.machines.chart.orient", "cairn.machines.chart.tree")
