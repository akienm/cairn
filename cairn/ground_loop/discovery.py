...
subdirectory in it; its id is the directory's own name (``cairn/librarian/probes`` → the
...
# ``skills/intent/probes`` and ``cairn/librarian/probes`` the same kind of thing without
