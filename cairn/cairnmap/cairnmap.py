"""cairn/cairnmap/cairnmap.py — the help surface, compiled from charters. Zero inference.
...
def roots_parent() -> Path:
    ...
    return Path(__file__).resolve().parents[3]        # cairn/cairnmap/ -> cairn/ -> repo -> parent
