...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/machines/triage/proofs/test_chart_triage.py     # exit 0 = green
"""
...
import cairn.machines.decompose.decompose as decompose_mod
from cairn.machines.triage import triage as triage_mod
from cairn.machines.triage.triage import (
...
def test_the_door_composes_the_installed_judges(root, survey_berth,
    ...
    assert "cairn.machines.triage.triage" not in inspector_src, \
...
def test_import_allowlist(root, survey_berth, decompose_berth):
    ...
    allow = ("__future__", "hashlib", "json", "os", "time",
             "cairn.machines.build_inspector.inspector", "cairn.machines.decompose.decompose",
