...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/machines/verdict/proofs/test_chart_verdict.py     # exit 0 = green
"""
...
from cairn.machines.verdict import verdict as verdict_mod
from cairn.machines.verdict.verdict import (
