...
running those criteria, and the ONE validator both consumers compose:
  ...
  - the EXIT GATE (build_inspector.proved_answers_the_chart, called from the emit
    ...
    may close;
  - the DEPOSIT FACE (cairn.machines.chart.live's verdict- branch) re-validates the same
...
TREE-FREE BY CONSTRUCTION: like cairn.machines.chart.orient (the wire's standing
...
from cairn.machines.chart.orient import (CAIRN_ROOT, INSTANCE_DIR, ticket_claim_error,
                                ticket_path)
