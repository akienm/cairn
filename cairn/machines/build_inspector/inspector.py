...
def charted_refs_resolve(row: dict, comp_dir: Path) -> list[dict]:
    ...
    gate's own ref semantics (cairn.devices.codemother.machines.orient.orient.ref_exists), so the judge and
...
# artifact (cairn/devices/codemother/machines/verdict/verdict.py — the ONE validator, shared with the deposit
