...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/devices/codemonkey/machines/survey/proofs/test_chart_survey.py     # exit 0 = green
"""
...
from cairn.devices.codemonkey.machines.survey import survey as survey_mod
from cairn.devices.codemonkey.machines.survey.survey import (
...
def test_the_fixture_speaks_what_the_orient_floor_AUTHORS(root, orient_berth,
    ...
    from cairn.devices.codemonkey.machines.orient.orient import floor_packet
...
def test_the_door_composes_the_installed_judges(root, orient_berth, constrain_berth):
    ...
    assert "cairn.devices.codemonkey.machines.survey.survey" not in inspector_src, \
