...
is a finding, not noise).
    ...
    python3 -m cairn.machines.chart.dial            # the live berth
    python3 -m cairn.machines.chart.dial <dir>      # any berth
"""
...
import cairn.machines.chart.constrain as _constrain
import cairn.machines.chart.decompose as _decompose
import cairn.machines.chart.hypothesize as _hypothesize
import cairn.machines.chart.survey as _survey
import cairn.machines.chart.triage as _triage
import cairn.machines.chart.validate as _validate
from cairn.machines.chart.orient import AUTHORED_FIELDS, INSTANCE_DIR, STRATA
