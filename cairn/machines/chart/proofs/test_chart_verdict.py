...
DB teeth need the one-time provisioning (as the tree proof). Self-cleaning.
    ...
    python3 cairn/machines/chart/proofs/test_chart_verdict.py     # exit 0 = green
"""
...
from cairn.machines.chart import verdict as verdict_mod
from cairn.machines.chart.verdict import (
...
from cairn.machines.chart import live as live_mod
from cairn.machines.chart.live import deposit_verdict, drain_pending
