...
db_domain (nonce table, self-cleaning), as in the trees and loop proofs.
    ...
    python3 cairn/devices/librarian/proofs/test_librarian_library.py     # exit 0 = green
"""
...
from cairn.devices.librarian import library
...
def test_library_opens_no_door_of_its_own():
    # cairn.tools.base.address joined 2026-08-12 (one-owner-for-the-instance-address): LIBRARY_ROOT
