...
def import_map(path, *, root: Path | None = None) -> dict:
    ...
    module entering is exactly ``cairn.devices.codemother.machines.constrain.constrain`` — the identical module the
    ...
    return {
        ...
        "provenance": "2026-07-28: allowlist teeth read the import's SPELLING, so the "
                      "loose form 'from cairn.devices.codemother.machines.constrain import constrain' recorded as its "
